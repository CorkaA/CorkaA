...
|--------|----------|------------|
| [Блок "Карточка товара" (в работе)](https://github.com/CorkaA/) | Редизайн и вёрстка блока карточки товара для Teaboom.ru. | HTML5, CSS3, JavaScript (ES6, Fetch API), JSON, pen.dev |
| [Сайт "Вязаные игрушки" (в работе)](https://github.com/CorkaA/) | Самописный сайт для демонстрации моих вязаных изделий. | HTML5, CSS3, JavaScript (ES6, Fetch API), JSON, npoint.io, pen.dev |
